<template>
	<div class="page-article">
		<van-image lazy-load :src="articleData.backdropImg" class="banner"/>
		<div class="content">
			<img
...
<script>
import Vue from "vue";
import {Divider, Lazyload, Image as VanImage} from "vant";

Vue.use(Divider).use(Lazyload).use(VanImage);
